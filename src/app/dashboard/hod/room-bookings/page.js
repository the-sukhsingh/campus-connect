  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="mb-6">
        ...
        <p className="text-gray-600 mt-1">Manage and approve room booking requests</p>
      </div>
      ...
      {loading ? (
        ...
        <div className="bg-white rounded-lg shadow-sm p-6 text-center">
          ...
          <p className="mt-1 text-gray-500">No room bookings match your current filters.</p>
        ...
        <div className="space-y-6">
          {bookings.map((booking) => (
            <div key={booking._id} className="bg-white rounded-lg shadow-sm overflow-hidden border border-gray-100">
              <div className="flex flex-wrap md:flex-nowrap">
                {/* Left side with booking details */}
                <div className="w-full md:w-3/4 p-6">
                  <div className="flex items-center justify-between mb-2">
                    <h2 className="text-xl font-semibold text-gray-900">{booking.room?.name || 'Unnamed Room'}</h2>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-900">{displayDate(booking.date)}</p>
                      </div>
                    </div>
                    <div className="flex items-start">
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-900">{formatTimeRange(booking.startTime, booking.endTime)}</p>
                      </div>
                    </div>
                    <div className="flex items-start">
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-900">{booking.requestedBy?.displayName || 'Unknown'}</p>
                        <p className="text-xs text-gray-500">({booking.requestedBy?.role || 'user'})</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="mb-4">
                    ...
                    <p className="text-sm text-gray-900">{booking.purpose || 'No purpose specified'}</p>
                  </div>
                ...
                <div className="w-full md:w-1/4 bg-gray-50 p-6 flex flex-col justify-center items-center border-t md:border-t-0 md:border-l border-gray-100">
                  {booking.status === 'pending' ? (
                    <>
                      <button
                        onClick={() => handleApproveBooking(booking._id)}
                        disabled={loadingAction}
                        className="w-full mb-3 inline-flex justify-center items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                      >
                        Approve
                      </button>
                      <button
          ...
          <div className="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div className="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
              <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                <h3 className="text-lg leading-6 font-medium text-gray-900 mb-4">Reject Booking Request</h3>
                <div>
