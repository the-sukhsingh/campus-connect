  ...
  return (
    <div className={`p-6 ${theme === 'dark' ? 'bg-gray-900 text-white' : 'bg-gray-50 text-gray-900'}`}>
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
        <div>
          <h1 className={`text-2xl font-bold ${theme === 'dark' ? 'text-white' : 'text-gray-900'}`}>College Management</h1>
        ...
        <div className={`${theme === 'dark' ? 'bg-gray-800' : 'bg-white'} rounded-lg shadow-md overflow-hidden`}>
          <div className={`px-6 py-4 ${theme === 'dark' ? 'border-gray-700' : 'border-gray-200'} border-b`}>
            <div className="flex justify-between items-center">
              <h2 className={`text-lg font-semibold ${theme === 'dark' ? 'text-white' : 'text-gray-900'}`}>College Details</h2>
              {!isEditing ? (
                <button
                  onClick={() => setIsEditing(true)}
                  className={`inline-flex items-center px-3 py-1.5 border text-sm leading-5 font-medium rounded-md
                    ${theme === 'dark' ? 'border-gray-600 text-gray-200 bg-gray-700 hover:bg-gray-600' : 'border-gray-300 text-gray-700 bg-white hover:bg-gray-50'} focus:outline-none`}
                >
          ...
          <div className={`px-6 py-4 ${theme === 'dark' ? 'bg-gray-750' : 'bg-gray-50'}`}>
            <div className={`border rounded-md overflow-hidden ${theme === 'dark' ? 'border-gray-700' : 'border-gray-200'}`}>
              {isEditing ? (
                <form onSubmit={handleSubmit} className={`${theme === 'dark' ? 'bg-gray-800' : 'bg-white'} p-6 space-y-6`}>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      <label htmlFor="name" className={`block text-sm font-medium ${theme === 'dark' ? 'text-gray-200' : 'text-gray-700'} mb-1`}>
                        College Name
                      </label>
                      <input
                        id="name"
                    ...
                    <div>
                      <label htmlFor="code" className={`block text-sm font-medium ${theme === 'dark' ? 'text-gray-200' : 'text-gray-700'} mb-1`}>
                        College Code
                      </label>
                      <input
                        id="code"
                    ...
                    <div>
                      <label htmlFor="domain" className={`block text-sm font-medium ${theme === 'dark' ? 'text-gray-200' : 'text-gray-700'} mb-1`}>
                        Email Domain
                      </label>
                      <input
                        id="domain"
                    ...
                    <div>
                      <label htmlFor="active" className={`block text-sm font-medium ${theme === 'dark' ? 'text-gray-200' : 'text-gray-700'} mb-1`}>
                        Status
                      </label>
                      <select
                        id="active"
                  ...
                  <div>
                    <label htmlFor="departments" className={`block text-sm font-medium ${theme === 'dark' ? 'text-gray-200' : 'text-gray-700'} mb-1`}>
                  ...
                  <div className="flex justify-end">
                    <button
                      ...
                      className={`inline-flex justify-center items-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white ${theme === 'dark' ? 'bg-indigo-600 hover:bg-indigo-700' : 'bg-blue-600 hover:bg-blue-700'} focus:outline-none ${
                ...
                <div className={`${theme === 'dark' ? 'bg-gray-800' : 'bg-white'} p-6`}>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      <h3 className={`text-sm font-medium ${theme === 'dark' ? 'text-gray-400' : 'text-gray-500'}`}>College Name</h3>
                      <p className={`mt-1 text-sm ${theme === 'dark' ? 'text-white' : 'text-gray-900'}`}>{collegeInfo.name}</p>
                    </div>
                    <div>
                      <h3 className={`text-sm font-medium ${theme === 'dark' ? 'text-gray-400' : 'text-gray-500'}`}>College Code</h3>
                      <p className={`mt-1 text-sm ${theme === 'dark' ? 'text-white' : 'text-gray-900'}`}>{collegeInfo.code}</p>
                    </div>
                    <div>
                      <h3 className={`text-sm font-medium ${theme === 'dark' ? 'text-gray-400' : 'text-gray-500'}`}>Email Domain</h3>
                      <p className={`mt-1 text-sm ${theme === 'dark' ? 'text-white' : 'text-gray-900'}`}>{collegeInfo.domain || 'Not specified'}</p>
                    </div>
                    <div>
                      <h3 className={`text-sm font-medium ${theme === 'dark' ? 'text-gray-400' : 'text-gray-500'}`}>Status</h3>
                    ...
                    <div className="md:col-span-2">
                      <h3 className={`text-sm font-medium ${theme === 'dark' ? 'text-gray-400' : 'text-gray-500'}`}>Departments</h3>
                      {collegeInfo.departments && collegeInfo.departments.length > 0 ? (
                        <div className="mt-1 flex flex-wrap gap-2">
                          {collegeInfo.departments.map((dept, index) => (
                            <span 
                              key={index}
                              className={`inline-flex items-center px-2.5 py-0.5 rounded-md text-sm font-medium ${theme === 'dark' ? 'bg-gray-700 text-gray-200' : 'bg-gray-100 text-gray-800'}`}
                            >
                              {dept}
                            </span>
                          ))}
                        ...
                        <p className={`mt-1 text-sm ${theme === 'dark' ? 'text-white' : 'text-gray-900'}`}>No departments specified</p>
                      )}
                    </div>
                    <div>
                      <h3 className={`text-sm font-medium ${theme === 'dark' ? 'text-gray-400' : 'text-gray-500'}`}>Created On</h3>
                      <p className={`mt-1 text-sm ${theme === 'dark' ? 'text-white' : 'text-gray-900'}`}>{formatDate(collegeInfo.createdAt)}</p>
                    </div>
                  </div>
                </div>
              )}
