...
function HodDashboard() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50 p-4 sm:p-6">
      ...
      <div className="bg-gradient-to-r from-red-50 to-pink-50 border border-red-200 rounded-2xl p-4 mb-6 transition-all duration-300 hover:shadow-lg">
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between">
          <div className="flex items-start mb-4 sm:mb-0">
            ...
            <div className="ml-4">
              ...
              <p className="text-red-600">Create and manage urgent safety notifications</p>
            </div>
          </div>
          <Link
            href="/dashboard/safety-alerts"
            className="w-full sm:w-auto px-4 py-2 bg-gradient-to-r from-red-600 to-red-700 text-white rounded-lg hover:from-red-700 hover:to-red-800 transition-all duration-300 text-sm font-medium flex items-center justify-center"
          >
      ...
      {loading ? (
        ...
        <>
          {!collegeInfo ? (
            <div className="bg-gradient-to-r from-yellow-50 to-orange-50 border-l-4 border-yellow-400 rounded-lg p-6 mb-6 shadow-sm">
              <div className="flex flex-col sm:flex-row sm:items-center">
                <div className="flex-shrink-0 mb-4 sm:mb-0">
                  <svg className="h-12 w-12 text-yellow-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                    <path fillRule="evenodd" d="M8.257 3.099c.765-1.36 2.722-1.36 3.486 0l5.58 9.92c.75 1.334-.213 2.98-1.742 2.98H4.42c-1.53 0-2.493-1.646-1.743-2.98l5.58-9.92zM11 13a1 1 0 11-2 0 1 1 0 012 0zm-1-8a1 1 0 00-1 1v3a1 1 0 002 0V6a1 1 0 00-1-1z" clipRule="evenodd" />
                  </svg>
                </div>
                <div className="sm:ml-5">
                  <h3 className="text-lg font-medium text-yellow-800">College Setup Required</h3>
                  ...
                  <div className="mt-4">
                    <button
                      ...
                      className="inline-flex items-center px-6 py-3 border border-transparent text-base font-medium rounded-lg bg-gradient-to-r from-indigo-500 to-indigo-600 text-white hover:from-indigo-600 hover:to-indigo-700 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                    >
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
              ...
              <div className="bg-white rounded-2xl overflow-hidden shadow-sm transition-all duration-300 hover:shadow-xl lg:col-span-2 border border-gray-100">
                ...
                <div className="p-5">
                  <div className="space-y-3">
                    <div className="flex flex-col">
                      <span className="text-xs text-gray-500 uppercase tracking-wider">College Name</span>
                      <span className="font-medium text-gray-800">{collegeInfo.name}</span>
                    </div>
                    <div className="flex flex-col">
                      <span className="text-xs text-gray-500 uppercase tracking-wider">College Code</span>
                      <span className="font-medium text-gray-800">{collegeInfo.code}</span>
                    </div>
                    <div className="flex flex-col">
                      <span className="text-xs text-gray-500 uppercase tracking-wider">Domain</span>
                      <span className="font-medium text-gray-800">{collegeInfo.domain}</span>
                    </div>
                  </div>
                  <div className="mt-6">
                    <button
              ...
              <div className="bg-white h-fit rounded-2xl overflow-hidden shadow-sm transition-all duration-300 hover:shadow-xl border border-gray-100">
              ...
              <div className="sm:col-span-3 grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6">
                ...
                <div className="bg-gradient-to-br from-green-50 to-teal-50 rounded-2xl overflow-hidden shadow-sm transition-all duration-300 hover:shadow-xl border border-green-100 hover:border-green-200 flex flex-col">
                  <div className="p-5 flex-grow">
                    ...
                    <h2 className="text-xl font-bold text-green-800 mb-2">Classes</h2>
                  ...
                  <div className="mt-auto p-5 pt-0">
                    <button
                      ...
                      className="w-full group inline-flex items-center justify-center px-4 py-2 rounded-lg text-sm font-medium text-white bg-gradient-to-r from-green-500 to-teal-600 hover:from-green-600 hover:to-teal-700 transition-all duration-300"
                    >
                      View Classes
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 ml-1 transform transition-transform duration-300 group-hover:translate-x-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                ...
                <div className="bg-gradient-to-br from-purple-50 to-indigo-50 rounded-2xl overflow-hidden shadow-sm transition-all duration-300 hover:shadow-xl border border-purple-100 hover:border-purple-200 flex flex-col">
                  <div className="p-5 flex-grow">
                    ...
                    <h2 className="text-xl font-bold text-purple-800 mb-2">Teachers</h2>
                    <p className="text-sm text-gray-600 mb-3">
                  ...
                  <div className="mt-auto p-5 pt-0">
                    <button
                      ...
                      className="w-full group inline-flex items-center justify-center px-4 py-2 rounded-lg text-sm font-medium text-white bg-gradient-to-r from-purple-500 to-indigo-600 hover:from-purple-600 hover:to-indigo-700 transition-all duration-300"
                    >
                      Manage Teachers
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 ml-1 transform transition-transform duration-300 group-hover:translate-x-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                ...
                <div className="bg-gradient-to-br from-blue-50 to-teal-50 rounded-2xl overflow-hidden shadow-sm transition-all duration-300 hover:shadow-xl border border-blue-100 hover:border-blue-200 flex flex-col">
                  <div className="p-5 flex-grow">
                    ...
                    <h2 className="text-xl font-bold text-blue-800 mb-2">Library</h2>
                    <p className="text-sm text-gray-600 mb-3">
                  ...
                  <div className="mt-auto p-5 pt-0">
                    <button
                      ...
                      className="w-full group inline-flex items-center justify-center px-4 py-2 rounded-lg text-sm font-medium text-white bg-gradient-to-r from-blue-500 to-teal-600 hover:from-blue-600 hover:to-teal-700 transition-all duration-300"
                    >
                      Manage Library
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 ml-1 transform transition-transform duration-300 group-hover:translate-x-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
              ...
              <div className="bg-white rounded-2xl overflow-hidden shadow-sm transition-all duration-300 hover:shadow-xl sm:col-span-3 border border-gray-100">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                      {announcements.map((announcement) => (
                        <div 
                          ...
                          className="bg-gradient-to-br from-gray-50 to-blue-50 rounded-xl p-4 hover:shadow-md transition-all duration-300 border border-gray-100"
                        >
                          <div className="flex justify-between items-start mb-2">
                            <h3 className="font-semibold text-gray-800 line-clamp-1">{announcement.title}</h3>
